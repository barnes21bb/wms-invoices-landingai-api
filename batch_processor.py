...
class BatchProcessor:
    ...
    def process_single_file(self, file_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            extracted_data = {
                "file_path": file_path,
                "extraction": (
                    result.extraction.model_dump() if result.extraction else None
                ),
    ...
    def save_results(
        self, results: List[Dict[str, Any]], output_filename: str = "batch_results.json"
    ):
    ...
    def generate_summary(self, results: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        return {
            "processing_summary": {
                ...
                "failed": failed,
                "success_rate": (
                    f"{(successful/total_files)*100:.1f}%" if total_files > 0 else "0%"
                ),
            },
            "financial_summary": {
